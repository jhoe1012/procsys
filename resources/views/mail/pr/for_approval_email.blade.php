...
<body>
    <div class="container">
        <h2>Approval Required: Purchase Requisition {{ $pr_header->pr_number }}</h2>
        <p>Dear {{ $approver_name }},</p>
        <p>I am writing to seek your approval for a purchase requisition that has been submitted for review. Below are
            the details of the requisition:</p>
        <div class="details">
