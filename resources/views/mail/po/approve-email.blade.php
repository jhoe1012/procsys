...
<body>
    <div class="container">
        <h2>Approval Granted: Purchase Order {{ $po_header->po_number }} is {{ $po_header->status }}</h2>
        <p>Dear {{ $requestor }},</p>
        <p>I am pleased to inform you that the Purchase order (PO) you submitted has been reviewed and approved.
            Below are the details of the approved order.</p>
        <div class="details">
